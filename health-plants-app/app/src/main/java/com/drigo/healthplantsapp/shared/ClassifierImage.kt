package com.drigo.healthplantsapp.shared
...
class ClassifierImage(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    fun recognizeImage(bitmap: Bitmap): List<ClassifierImage.Recognition> {
    ...
    private fun getSortedResult(labelProbArray: Array<FloatArray>): List<ClassifierImage.Recognition> {
        ...
        val recognitions = ArrayList<ClassifierImage.Recognition>()
